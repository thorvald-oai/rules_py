...
# `compression-level`, None when the filter has no level knob.
ALGORITHMS = {
    "bzip2": struct(flag = "--bzip2", filter = "bzip2", ext = ".tar.bz2", min_level = 1, max_level = 9),
    "compress": struct(flag = "--compress", filter = None, ext = ".tar.Z", min_level = 0, max_level = 0),
    "gzip": struct(flag = "--gzip", filter = "gzip", ext = ".tar.gz", min_level = 0, max_level = 9),
    "lrzip": struct(flag = "--lrzip", filter = "lrzip", ext = ".tar.lrz", min_level = 1, max_level = 9),
    # lz4 rejects level 0 outright ("Undefined option"), unlike gzip/xz/lzma.
    "lz4": struct(flag = "--lz4", filter = "lz4", ext = ".tar.lz4", min_level = 1, max_level = 9),
    "lzma": struct(flag = "--lzma", filter = "lzma", ext = ".tar.lzma", min_level = 0, max_level = 9),
    "lzop": struct(flag = "--lzop", filter = "lzop", ext = ".tar.lzo", min_level = 1, max_level = 9),
    "none": struct(flag = None, filter = None, ext = ".tar", min_level = 0, max_level = 0),
    "xz": struct(flag = "--xz", filter = "xz", ext = ".tar.xz", min_level = 0, max_level = 9),
    "zstd": struct(flag = "--zstd", filter = "zstd", ext = ".tar.zst", min_level = -131072, max_level = 22),
}
...
""",
    attrs = {
        ...
        "extension": attr.string(
            mandatory = True,
            doc = "Extension for tars this compressor produces, e.g. '.tar.br'. Must start with '.'.",
        ),
        "tool": attr.label(
            mandatory = True,
            executable = True,
